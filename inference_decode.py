...
class SentenceDecoder:
    ...
    def decode_sampling(self, temperature, top_k, top_p, max_len=30):
        """
    ...
    @staticmethod
    def filter_top_k_top_p(logits, top_k=0, top_p=0.0, filter_value=-float('Inf')):
        """
    ...
    def _sample_next_token(self, dec_out, temperature, top_k, top_p):
        """
