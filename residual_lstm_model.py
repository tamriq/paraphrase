...
class ResidualEncoder(nn.Module):
    ...
    def __init__(self, input_dim, hidden_enc_dim, hidden_dec_dim):
        ...
        :param hidden_enc_dim: the size of the encoder hidden layer
        :param hidden_dec_dim: the size of the decoder hidden layer
        """
        super().__init__()
        #
...
class Seq2SeqResidual(nn.Module):
    ...
    def __init__(self, encoder, decoder, batch_size, vocab_size):
        """
        Initialize the Seq2SeqResidual class.
